...
List<EventItem> getDummyAotEvents() {
  ...
  return [
    ...
    EventItem(
      ...
      eventTimeUtc: DateTime.utc(2025, 2, 14, 12, 0), // 19:00 WIB
    ...
    EventItem(
      ...
      eventTimeUtc: DateTime.utc(2025, 1, 24, 3, 0), // 10:00 WIB
    ...
    EventItem(
      ...
      eventTimeUtc: DateTime.utc(2025, 5, 10, 4, 0), // 11:00 WIB
    ...
    EventItem(
      ...
      eventTimeUtc: DateTime.utc(2025, 10, 25, 3, 0), // 10:00 WIB
      originalTimeZoneLabel: '10:00 WIB (Jakarta)',
    ...
    EventItem(
      ...
      eventTimeUtc: DateTime.utc(2025, 10, 12, 9, 0), // 18:00 JST
    ...
    EventItem(
      ...
      eventTimeUtc: DateTime.utc(2025, 11, 4, 3, 0), // 19:00 PST (UTC-8)
    ...
    EventItem(
      ...
      eventTimeUtc: DateTime.utc(2025, 8, 28, 9, 0), // 11:00 CEST
